...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I am currently pursuing B.Tech degree in Computer Science Engineering.<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br>C++(one of my best langauge)<br>C<br>Python<br>CSS<br>HTML</span><br><br>I've experiance with following frameworks :<span class='bold'><br>ReactJs</span><br><br>I use <span class='bold'>Arch Linux</span> as daily driver on my Lenovo Ideaflrx 5<br>OS:Arch Linux<br>Favourite IDE:VSCode</span>");
            break;
